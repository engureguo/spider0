package com.engure.spider.service.spider;

import com.engure.spider.service.spider.strategy.ProcessStrategy;
...
public class DefaultSpider implements PageProcessor {
    ...
    private Site site = Site.me().setRetryTimes(3)
            .setSleepTime(2 * ONE_SECOND)
            .setRetrySleepTime(2 * ONE_MINUTES);
    ...
    public void process(Page page) {
        ...
        preProcess(page);
        processStrategy.doProcess(page);//策略模式，将具体的页面处理方法抽离
        afterProcess(page);
    }
